...
// let current_song = "Morning Sex";
// let current_song = "Aw Sh*t!";
...
router.get("/", function (req, res, next) {
  (async () => {
    ...
    res.render("index", {
      artist: song_entry.artist.name,
      year: album.date.substr(0, 4),
      artist_note: song_entry.artist.note,
      album: album_name,
      album_note: song_entry.album.note,
      song: song.title,
      song_note: song_entry.note,
